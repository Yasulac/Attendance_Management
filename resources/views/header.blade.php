 ...
 <div class="container-fluid">
   <section class="first-container-section-1">
    <div class="row align-items-start">
        ...
        <div  class="col">
            <div class="col-2">
                <img style="margin-left: auto; margin-right:auto;" src="https://png.pngtree.com/png-clipart/20211017/original/pngtree-school-logo-png-image_6851480.png" height="100" width="100" alt="">
            </div>
        </div>
        <div class="col">
            <div class="row align-items-end">
                 <div class="col">
                       <div style="text-align: end;">
                        <button class="btn btn-light" style="padding: 10px 20px 10px 20px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" style="margin-right: 10px;" class="bi bi-person-circle" viewBox="0 0 16 16">
                        <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                        <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
                        </svg>
                        <a  class="login" style="color: black;" href="login">Log in</a>
                        </button>
                       </div>
                 </div>
   ...
   <section class="second-section-1">
        <div class="second-section-1-ul" style="color: white;">
